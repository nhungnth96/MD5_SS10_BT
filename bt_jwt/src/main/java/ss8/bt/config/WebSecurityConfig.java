...
import ss8.bt.security.jwt.JwtEntryPoint;
import ss8.bt.security.jwt.JwtTokenFilter;
import ss8.bt.security.userprincipal.UserDetailService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().configurationSource(request -> {
            ...
            return cfg;
                ...
                .antMatchers("/api/auth/admin").hasRole("ADMIN") // cấu hình theo pattern
